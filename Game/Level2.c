...
int main(void) {
    ...
    float sharkSpeed = 6.5f; // Shark speed for movement                                       // changed to 6.5

    // Scaling factor for shark sprite // size of the shark
    ...
    for (int i = 0; i < MAX_OBSTACLES; i++) {
        ...
        obstacles[i].speed = GetRandomValue(7,11);                                                    //changed to 7 and 11
    ...
    while (!WindowShouldClose()) {
        ...
        // IsKeyDown() checks if the key is pressed
